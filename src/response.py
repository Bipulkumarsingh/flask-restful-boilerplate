...
class ResponseData(metaclass=ResponseMeta):
    def __init__(self):
        self.RESPONSE = {"version": {"version": "1.0.0.0", "name": "SadhuTech"},
    ...
    def http_203(self, **kwargs) -> Tuple:
        ...
        status.update(kwargs)
        return self.response(status), 203
    ...
    def http_405(self, **kwargs) -> Tuple:
        ...
        status.update(kwargs)
        return self.response(status), 405
    ...
    def http_406(self, **kwargs) -> Tuple:
        ...
        status.update(kwargs)
        return self.response(status), 406
    ...
    def http_409(self, **kwargs) -> Tuple:
        ...
        status.update(kwargs)
        return self.response(status), 409
